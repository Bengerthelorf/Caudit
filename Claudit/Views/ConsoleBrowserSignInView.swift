...
/// Embedded browser for signing into console.anthropic.com to extract session cookie.
struct ConsoleBrowserSignInView: NSViewRepresentable {
    ...
    func makeNSView(context: Context) -> WKWebView {
        ...
        webView.load(URLRequest(url: URL(string: "https://console.anthropic.com/login")!))
        return webView
    }
    ...
    class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
        let onSessionKey: (String, Date?) -> Void
        private let targetDomain = "console.anthropic.com"
